...
<body>
  ...
  <text text-anchor="middle" x="50" y="10" font-size="5" fill="url(#wave)"  fill-opacity="1">Registre uma conta ou efetue login caso já seja um membro do nosso fórum!</text><br/>
</svg>
<?php 
if (!empty($erros)):
...
<center>
<fieldset id="name1">
<img src="https://marquesfernandes.com/wp-content/uploads/2020/08/kwi4bvgzths31.jpg" width="20%"></fieldset> <fieldset id="name2"><img src="https://cio.com.br/wp-content/uploads/2020/10/linguagem-programacao-python-1024x576.jpg" width="20%"></fieldset> <fieldset id="name3"><img src="https://images.hdqwalls.com/download/python-programming-syntax-4k-1s-1920x1080.jpg" width="20%"></fieldset> <fieldset id="name4"><img src="https://images8.alphacoders.com/947/thumb-1920-947346.jpg" width="20%"></fieldset>
</center>
</body >
</html>
